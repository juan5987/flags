        ...
        <ol className='rules__list'>
          ...
          <li className='rules__list__element'>
            ...
            <span className='rules__list__element__content'>
              ...
              score. Si vous souhaitez apparaître dans le classement des
              meilleurs scores, <b>pensez donc à vous enregistrer</b> sur le
              site.
            </span>
          </li>
          <li className='rules__list__element'>
            ...
            <span className='rules__list__element__content'>
              Apprenez en vous amusant et améliorer votre score pour atteindre
